...
def launch_setup(context, *args, **kwargs):
    ...
    # ========== added in snap ==========
    ffmpeg_params_file = LaunchConfiguration("ffmpeg_params_file")
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("params_file", default_value="/var/snap/husarion-depthai/common/depthai_params.yaml"),
        ...
        # ========== added in snap ==========
        DeclareLaunchArgument("ffmpeg_params_file", default_value="/var/snap/husarion-depthai/common/ffmpeg_params.yaml", description="Full path to the FFMPEG plugin parameters file"),
        DeclareLaunchArgument("namespace",default_value=EnvironmentVariable("namespace", default_value=""), description="Namespace which will appear in front of all topics (including /tf and /tf_static)."),
        # ===================================
    ]
